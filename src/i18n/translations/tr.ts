export default {
  ...
  booking: {
    ...
    emailPlaceholder: 'ör. alexander@kulup.com',
    phoneLabel: 'Telefon / WhatsApp',
    phonePlaceholder: '+90 5XX XXX XX XX',
    sportLabel: 'Spor Kategorisi',
  ...
  errors: {
    e404Title: '404 — Sayfa Bulunamadı',
    e404Desc: 'Aradığınız spor rotası veya sayfa mevcut değil, süresi dolmuş veya taşınmış.',
