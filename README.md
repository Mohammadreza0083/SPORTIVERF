...
- Custom Light Luxury error pages with Vazirmatn/Inter typography and localized CTAs:
  - `404.astro` / `[locale]/404.astro` (*Out of Bounds*)
  - `403.astro` / `[locale]/403.astro` (*Access Forbidden*)
  - `500.astro` / `[locale]/500.astro` (*Internal Server Timeout*)
  - `400.astro` / `[locale]/400.astro` (*Bad Request Format*)
